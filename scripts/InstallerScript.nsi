 ...
 *  NSIS Setup script
 *
 * (c) 2019 by Hernán Morales Durand, All rights reserved
 *
...
!define PROVIDER "Hernán Morales Durand"
!define PRODUCT  "BlastQB"
!define PRODUCT_LOWERCASE "blastqb"
!define URL      "https://github.com/hernanmd/BlastQB"
!define YEAR     "2019"
!define LAUNCHER "pharo-vm\BlastQB.exe"
!define LICENSE_EN "LICENSE_ENGLISH.txt"
!define VERSION "0.0.0.1"
!define RESDIR "c:\git_projects\BlastQB"
...
###################################
; Other Definitions
!define MUI_ICON   "${RESDIR}\BlastQBIcon.ico"                              ; icon for the installer

!define MUI_HEADERIMAGE
# !define MUI_HEADERIMAGE_BITMAP "$RESDIR\header.bmp"                 ; optional
!define MUI_WELCOMEFINISHPAGE_BITMAP "${RESDIR}\BlastQBWelcome.bmp"     ; optional
...
Section "Pharo VM" Section1
  ...
  DetailPrint "Installation Started."
	...
	File "pharo-vm\BlastQB.exe"
	File "pharo-vm\FileAttributesPlugin.dll"	
	...
	File README.txt 
	File "${RESDIR}\splash.bmp"
	File "${RESDIR}\Pharo7.0-32bit-ccd1f64.sources"
	;File "pharo-vm\ProcessWrapperPlugin.dll"
  ...
  ;WriteRegDWord HKCU "${REG_UNINSTALL}" "EstimatedSize"  ;MB
...
Section "Image and Sources" Section2
  ...
  File BlastQB-${VERSION}.changes
  File BlastQB-${VERSION}.image
  File "pharo-vm\"  
...
SetOutPath $INSTDIR
    ...
    Delete "$INSTDIR\BlastQB.exe"
    Delete "$INSTDIR\BlastQB-1.0.changes"
    Delete "$INSTDIR\BlastQB-1.0.image"
	 Delete "$INSTDIR\"
    Delete "$INSTDIR\"
	...
	Delete "$INSTDIR\Pharo7.0-32bit-ccd1f64.sources"
...
Function .onInit
	...
	; MessageBox MB_OK "BlastQB is installed at $R0"	
	StrCmp $R0 "" done
...
uninst:	
   ...
   ; Pop $R1
	...
	System::Call 'kernel32::CreateMutexA(i 0, i 0, t "BlastQBMutex") i .r1 ?e'
	Pop $R0
